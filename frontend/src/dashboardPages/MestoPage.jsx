...
export const MestoPage = () => {
    ...
    const fetchData = () => {
        axios.get(IP + "/mesta").then(response => setData(response.data));
    }
    ...
    return <div className="d-flex flex-column flex-nowrap w-100 mx-5">
        ...
        <ul className="list-group list-group-flush">
            ...
            {data.map((m) => <MestoData key={m.id_mesto} id_mesto={m.id_mesto} nazev={m.nazev} onRefresh={fetchData}/>)}
        </ul>
    </div>
}